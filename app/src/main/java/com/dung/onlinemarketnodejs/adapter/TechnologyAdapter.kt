...
import kotlinx.android.synthetic.main.list_item_technology.view.*
import java.text.DecimalFormat

class TechnologyAdapter(var context: Context, var list: ArrayList<Product>, var activity: MainScreenActivity) :
    RecyclerView.Adapter<TechnologyAdapter.ProductHolder>() {

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ProductHolder {
        var view = LayoutInflater.from(context).inflate(R.layout.list_item_technology, p0, false)
