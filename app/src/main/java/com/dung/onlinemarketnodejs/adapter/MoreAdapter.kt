...
import com.dung.onlinemarketnodejs.user.TechnologyActivity
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.list_item_product.view.*
import java.text.DecimalFormat

class MoreAdapter(var context: Context, var list: ArrayList<Product>, var activity: TechnologyActivity) :
    RecyclerView.Adapter<MoreAdapter.ProductHolder>() {
